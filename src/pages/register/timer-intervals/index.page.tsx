...
type TimerIntervalsFormDataInput = z.input<typeof timerIntervalsFormSchema>
type TimerIntervalsFormDataOutput = z.output<typeof timerIntervalsFormSchema>
...
export default function TimerIntervals() {
  ...
  } = useForm<TimerIntervalsFormDataInput, null, TimerIntervalsFormDataOutput>({
  ...
  async function handleSetTimeIntervals(data: TimerIntervalsFormDataOutput) {
